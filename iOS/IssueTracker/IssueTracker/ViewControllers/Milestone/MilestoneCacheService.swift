...
//            self?.milestones = (try? result.get().milestone) ?? []
            let milestone1 = Milestone(id: 1, title: "milestone1", content: "첫번째 마일스톤", deadline: "2020.11.03", isOpened: true)
            let milestone2 = Milestone(id: 2, title: "milestone2", content: "두번째 마일스톤", deadline: "2020.11.11", isOpened: true)
            let milestone3 = Milestone(id: 3, title: "milestone3", content: "세번째 마일스톤", deadline: "2020.11.22", isOpened: true)
